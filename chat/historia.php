...
<head>
    ...
    <title>Chat de Historia - EstudAI</title>
    <link rel="icon" href="icons/historia.ico">
  ...
  <div class="chat-container">
    ...
    <script>
        ...
        function fetchMessages() {
            fetch('php/fetch_messages_historia.php') // Arquivo específico para Geografia
        ...
        function sendMessage(event) {
            ...
            if (message) {
                fetch('php/send_messages_historia.php', { // Arquivo específico para Geografia
                    method: 'POST',
