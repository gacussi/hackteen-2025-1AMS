...
<head>
    ...
    <title>Chat de Matematica - EstudAI</title>
    <link rel="icon" href="icons/matematica.ico">
  ...
  <div class="chat-container">
    ...
    <script>
        ...
        function fetchMessages() {
            fetch('php/fetch_messages_matematica.php') // Arquivo específico para Geografia
        ...
        function sendMessage(event) {
            ...
            if (message) {
                fetch('php/send_messages_matematica.php', { // Arquivo específico para Geografia
                    method: 'POST',
