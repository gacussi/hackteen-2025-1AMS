...
<head>
    ...
    <title>Chat de Geografia - EstudAI</title>
    <link rel="icon" href="icons/geografia.ico">
  ...
  <div class="chat-container">
    ...
    <script>
        ...
        function fetchMessages() {
            fetch('php/fetch_messages_geografia.php') // Arquivo específico para Geografia
        ...
        function sendMessage(event) {
            ...
            if (message) {
                fetch('php/send_message_geografia.php', { // Arquivo específico para Geografia
                    method: 'POST',
